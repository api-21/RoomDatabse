...
class ConsultDataLyt : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = inflate(inflater, R.layout.fragment_consult_data_lyt, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnAddDataToLocal = ButtonLytBinding.inflate(layoutInflater)
        btnAddDataToLocal.btnLyt.text = "Add Data To Local "
        binding.consultLyt.addView(btnAddDataToLocal.btnLyt)
